# thmoviedb.prg => film ve dizi arşivi
# themoviedb' nin sunduğu apiyi uygulamanızda kullanınız.
# Anahtar kelimeye göre arama
# En pöpüler film listesi
# Vizyondaki filim listesi
...
class theMovieDb:
    def __init__(self):
        ...
        self.api_key = "<api_key>" # exapmle api key  and this api key is not available.
